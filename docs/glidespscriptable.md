...
description: GlideSPScriptable
layout: libdoc_page.liquid
eleventyNavigation:
    key: GlideSPScriptable
    parent: Docs
...
| [canReadRecord(string table, string sys_id)](https://developer.servicenow.com/app.do#!/api_doc?v=jakarta&id=r_GSPS-canReadRecord_S_S) |       |
...
| Method                                                                                                                           | Notes |
| -------------------------------------------------------------------------------------------------------------------------------- | ----- |
| [getCatalogItem(string sys_id)](https://developer.servicenow.com/app.do#!/api_doc?v=jakarta&id=r_GSPS-getCatalogItem_S)          |       |
| [getCatalogItem(string sys_id, boolean)](https://developer.servicenow.com/app.do#!/api_doc?v=jakarta&id=r_GSPS-getCatalogItem_S) |       |
...
| Method                                                                                                                                         | Notes |
| ---------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| [getForm(string table, string sys_id)](https://developer.servicenow.com/app.do#!/api_doc?v=jakarta&id=r_GSPS-getForm_S_S)                      |       |
| [getForm(string table, string sys_id, string query, string view)](https://demo.service-now.com/sp_widget_list.do?sysparm_query=id=widget-form) |       |
...
[getMenuItems(string
sys_id)](https://developer.servicenow.com/app.do#!/api_doc?v=jakarta&id=r_GSPS-getMenuItems_S)
...
| [getRecord(string table, string sys_id)](https://demo.service-now.com/sp_widget_list.do?sysparm_query=id=widget-form) | Not Documented, only works in global scope. |
...
sys_id)](https://developer.servicenow.com/app.do#!/api_doc?v=jakarta&id=r_GSPS-getStream_S_S)
...
| [getValues(string sys_id, object options)](https://developer.servicenow.com/app.do#!/api_doc?v=jakarta&id=r_GSPS-getValues_O_S) |                |
...
[getKBCount(string
sys_id)](https://demo.service-now.com/sp_widget_list.do?sysparm_query=sys_id=ee307070d7201200a9addd173e24d4da)
...
sys_id)](https://demo.service-now.com/sp_widget_list.do?sysparm_query=sys_id=122ac7f0d7101200a9addd173e24d411)
...
sys_id)](https://demo.service-now.com/sp_widget_list.do?sysparm_query=sys_id=c254be50d7201200a9addd173e24d410)
...
| Method                                                                                                                                                     | Notes |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| [logStat(string param 1, string table, string sys_id, string param 2)](https://demo.service-now.com/sp_widget_list.do?sysparm_query=id=widget-sc-cat-item) |       |
| [logStat(string param 1, string table, string sys_id)](https://demo.service-now.com/sp_widget_list.do?sysparm_query=id=widget-sc-order-guide)              |       |
...
[saveRecord(string table, string sys_id, array fields)](https://demo.service-now.com/sp_widget_list.do?sysparm_query=id=widget-form)
