...
| Query    | [Operators](/docs/operators/)                 | Query operators for filtering records                                                                                                   |
...
For a complete reference of query operators used with GlideRecord, see [Query Operators](/docs/operators/).